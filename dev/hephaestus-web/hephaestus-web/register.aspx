<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="hephaestus_web.register" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head runat="server">
        ...
        <title>Hephaestus - Registo de Conta</title>
                        ...
                        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                            <div class="card col-lg-4 mx-auto">
                                <div class="card-body px-5 py-5">
                                    <h3 class="card-title text-left mb-3">Registar Conta</h3>
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block enter-btn">Registar</button>
                                        </div>
                                        <div class="form-group">
                                            <button type="button" class="gsi-material-button w-100 btn-block" style="max-width: 100%;">
                                                ...
                                                <div class="gsi-material-button-content-wrapper justify-content-center">
                                                    ...
                                                    <span class="gsi-material-button-contents" style="flex-grow: 0;">Registar com Google</span>
                                                    <span style="display: none;">Registar com Google</span>
                                                </div>
                                            </button>
                                        </div>
