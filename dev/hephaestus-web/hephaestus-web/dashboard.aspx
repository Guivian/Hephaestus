...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="hephaestus-dashboard">
        ...
        <section class="row dashboard-kpis" aria-label="Indicadores principais">
            <div class="col-sm-6 col-xl-3 grid-margin stretch-card">
                <article class="card dashboard-kpi dashboard-kpi-primary">
                    <div class="card-body">
                        <div class="dashboard-kpi-header"><span class="dashboard-kpi-icon"><i class="mdi mdi-ticket-outline"></i></span><span id="kpiOpenTrend" class="dashboard-kpi-trend">—</span></div>
                        <div id="kpiOpen" class="dashboard-kpi-value">—</div>
                        <h3 class="dashboard-kpi-label">Tickets abertos</h3>
                        <p class="dashboard-kpi-help">Pedidos ativos relevantes para si</p>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-xl-3 grid-margin stretch-card">
                <article class="card dashboard-kpi dashboard-kpi-warning">
                    <div class="card-body">
                        <div class="dashboard-kpi-header"><span class="dashboard-kpi-icon"><i class="mdi mdi-alert-circle-outline"></i></span><span id="kpiAttentionTrend" class="dashboard-kpi-trend">—</span></div>
                        <div id="kpiAttention" class="dashboard-kpi-value">—</div>
                        <h3 class="dashboard-kpi-label">Requerem atenção</h3>
                        <p class="dashboard-kpi-help">Pendentes, atrasados ou por atribuir</p>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-xl-3 grid-margin stretch-card" data-permission="tasks-view">
                <article class="card dashboard-kpi dashboard-kpi-info">
                    <div class="card-body">
                        <div class="dashboard-kpi-header"><span class="dashboard-kpi-icon"><i class="mdi mdi-calendar-clock"></i></span><span id="kpiTodayTrend" class="dashboard-kpi-trend">—</span></div>
                        <div id="kpiToday" class="dashboard-kpi-value">—</div>
                        <h3 class="dashboard-kpi-label">Tarefas para hoje</h3>
                        <p class="dashboard-kpi-help">Intervenções planeadas para o dia</p>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-xl-3 grid-margin stretch-card">
                <article class="card dashboard-kpi dashboard-kpi-success">
                    <div class="card-body">
                        <div class="dashboard-kpi-header"><span class="dashboard-kpi-icon"><i class="mdi mdi-check-circle-outline"></i></span><span id="kpiResolvedTrend" class="dashboard-kpi-trend">—</span></div>
                        <div id="kpiResolved" class="dashboard-kpi-value">—</div>
                        <h3 class="dashboard-kpi-label">Resolvidos</h3>
                        <p class="dashboard-kpi-help">Tickets concluídos no período</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <div class="row">
                ...
                <section class="card w-100" aria-labelledby="attentionTitle">
                    <div class="card-body p-0">
                        <div class="dashboard-card-header">
                            <div>
                                <h4 id="attentionTitle" class="card-title mb-1">Tickets que requerem atenção</h4>
                                <p class="text-muted small mb-0">Pedidos prioritários, pendentes ou sem atribuição</p>
                            </div><a href="tickets_listing.aspx" class="btn btn-outline-secondary btn-sm">Ver todos</a>
                        </div>
                            ...
                            <table class="table dashboard-table mb-0">
                                ...
                                <tbody id="attentionTicketRows">
                                    <tr class="dashboard-empty-row">
                                        <td colspan="7">
                                            <div class="dashboard-empty"><i class="mdi mdi-ticket-outline"></i><strong>Sem tickets para apresentar</strong><span>Os tickets que necessitem de atenção serão apresentados aqui.</span></div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div class="col-xl-4 grid-margin stretch-card" data-permission="tasks-view">
                <section class="card w-100" aria-labelledby="agendaTitle">
                    <div class="card-body">
                        <div class="dashboard-card-header px-0 pt-0">
                            <div>
                                <h4 id="agendaTitle" class="card-title mb-1">Agenda de hoje</h4>
                                <p class="text-muted small mb-0">Próximas intervenções planeadas</p>
                            </div><a href="technician_calendar.aspx" class="btn btn-outline-secondary dashboard-icon-button" title="Abrir calendário"><i class="mdi mdi-calendar"></i></a>
                        </div>
            ...
            <div class="col-xl-7 grid-margin stretch-card">
                <section class="card w-100" aria-labelledby="statusChartTitle">
                    <div class="card-body">
                        <div class="dashboard-card-header px-0 pt-0">
                            <div>
                                <h4 id="statusChartTitle" class="card-title mb-1">Tickets por estado</h4>
                                <p class="text-muted small mb-0">Distribuição dos pedidos no período selecionado</p>
                            </div><select id="dashboardPeriod" class="form-control form-control-sm dashboard-period">
            ...
            <div class="col-xl-5 grid-margin stretch-card">
                <section class="card w-100" aria-labelledby="workloadTitle">
                    <div class="card-body">
                        <div class="dashboard-card-header px-0 pt-0">
                            <div>
                                <h4 id="workloadTitle" class="card-title mb-1">Carga por técnico</h4>
                                <p class="text-muted small mb-0">Intervenções abertas por responsável</p>
                            </div><i class="mdi mdi-account-group text-muted h4 mb-0"></i>
                        </div>
            ...
            <div class="col-xl-7 grid-margin stretch-card">
                <section class="card w-100" aria-labelledby="recentTitle">
                    <div class="card-body p-0">
                        <div class="dashboard-card-header">
                            <div>
                                <h4 id="recentTitle" class="card-title mb-1">Tickets recentes</h4>
                                <p class="text-muted small mb-0">Últimos pedidos disponíveis para o seu perfil</p>
                            </div><a href="tickets_listing.aspx" class="text-primary small">Histórico completo <i class="mdi mdi-arrow-right"></i></a>
                        </div>
            ...
            <div class="col-xl-5 grid-margin stretch-card">
                <section class="card w-100" aria-labelledby="activityTitle">
                    <div class="card-body">
                        <div class="dashboard-card-header px-0 pt-0">
                            <div>
                                <h4 id="activityTitle" class="card-title mb-1">Atividade recente</h4>
                                <p class="text-muted small mb-0">Comentários, anexos e alterações</p>
                            </div><i class="mdi mdi-bell-outline text-muted h4 mb-0"></i>
                        </div>
        ...
        <section class="card mb-4" aria-labelledby="quickActionsTitle">
            <div class="card-body">
                <div class="dashboard-card-header px-0 pt-0">
                    <div>
                        <h4 id="quickActionsTitle" class="card-title mb-1">Ações rápidas</h4>
                        <p class="text-muted small mb-0">Acesso direto às operações mais utilizadas</p>
                    </div>
                </div>
        ...
        <section class="card dashboard-admin-summary mb-4" data-permission="admin-view" aria-labelledby="adminSummaryTitle">
            <div class="card-body">
                <div class="dashboard-card-header px-0 pt-0">
                    <div>
                        <h4 id="adminSummaryTitle" class="card-title mb-1">Resumo administrativo</h4>
                        <p class="text-muted small mb-0">Contas e elementos operacionais que requerem acompanhamento</p>
                    </div><span class="badge badge-outline-info">Administração</span>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="admin-metric"><i class="mdi mdi-account-multiple"></i><span><strong id="adminTotalUsers">—</strong><small>Utilizadores</small></span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="admin-metric"><i class="mdi mdi-worker"></i><span><strong id="adminActiveTechnicians">—</strong><small>Técnicos ativos</small></span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mb-3 mb-sm-0">
                        <div class="admin-metric"><i class="mdi mdi-account-off"></i><span><strong id="adminInactiveUsers">—</strong><small>Contas inativas</small></span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="admin-metric"><i class="mdi mdi-ticket-account"></i><span><strong id="adminUnassignedTickets">—</strong><small>Tickets por atribuir</small></span></div>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        (function() {
            ...
            if (dateElement) {
                dateElement.textContent = new Date().toLocaleDateString('pt-PT', {
                    weekday: 'long',
                    day: '2-digit',
                    month: 'long',
                    year: 'numeric'
